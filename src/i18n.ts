...
const ZH: Record<string, string> = {
  ...
  "heading.search": "搜索",
  "heading.login": "登录",
  "login.hint-local": "本地默认口令见 .dev.vars 的 OWNER_TOKEN（示例 change-me-local-owner-token）。勿在生产复用。",
  "heading.settings": "设置",
...
const EN: Record<string, string> = {
  ...
  "login.hint-local": "Local default is OWNER_TOKEN in .dev.vars (example change-me-local-owner-token). Do not reuse in production.",
