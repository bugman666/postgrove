...
const ZH: Record<string, string> = {
  ...
  "login.address": "地址",
  "login.passphrase": "口令",
  "login.hint": "本地开发：口令是 .dev.vars 里的 OWNER_TOKEN（示例 change-me-local-owner-token）。生产见 docs/PRODUCTION_AUTH.md。",
...
const EN: Record<string, string> = {
  ...
  "login.hint": "Local development: the passphrase is OWNER_TOKEN in .dev.vars (example change-me-local-owner-token). For production, see docs/PRODUCTION_AUTH.md.",
