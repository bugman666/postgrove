...
const ZH: Record<string, string> = {
  ...
  "empty.search": "没有匹配「{q}」的信。",
  "empty.unread": "没有未读的信。",
  "empty.starred": "还没有星标。",
  "empty.pick": "从左侧选一封，或点「写信」。",
  "empty.addresses": "还没有地址。开一个，例如 you@yourdomain。",
...
const EN: Record<string, string> = {
  ...
  "nav.folders": "Folders",
  "nav.main": "Main",
  "empty.inbox": "No mail yet. After routing is set, send a note to your address.",
